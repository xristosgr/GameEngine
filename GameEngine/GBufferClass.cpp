...
void GBufferClass::Initialize(DX11& gfx11)
{
	...
	viewNormalTexture.Initialize(gfx11.device.Get(), gfx11.windowWidth, gfx11.windowHeight);
	viewPositionTexture.Initialize(gfx11.device.Get(), gfx11.windowWidth, gfx11.windowHeight);
	...
	m_renderTargetTextureArray[5] = viewNormalTexture.m_renderTargetTexture;
	m_renderTargetTextureArray[6] = viewPositionTexture.m_renderTargetTexture;
	...
	m_renderTargetViewArray[5] = viewNormalTexture.m_renderTargetView;
	m_renderTargetViewArray[6] = viewPositionTexture.m_renderTargetView;
	...
	m_shaderResourceViewArray[5] = viewNormalTexture.shaderResourceView;
	m_shaderResourceViewArray[6] = viewPositionTexture.shaderResourceView;
}
