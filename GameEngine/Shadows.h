...
public:
	...
	void SoftShadows(DX11& gfx11, ID3D11ShaderResourceView* shadowsResourceView, RectShape& blurRect, std::vector<Entity>& entities, std::vector<Light*>& lights, Camera& camera, float& renderDistance);
